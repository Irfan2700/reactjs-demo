...
const vaildEmail = (val) => /^[A-Z0-9.%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(val);
...
class Contact extends Component {
    ...
    handleSubmit (values) {
        ...
        console.log("here is contact props", this.props);
        ...
        render() {
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-12"><h3>Contact Us</h3></div>
                </div>
                        ...
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    messages={{
                                        required: 'Required ',
                                        vaildEmail: 'Invaild Email Address'
                                    }} />
                                </Col>
                            </Row>
                            <Row className="form-group">
